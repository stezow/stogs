...
// ********************************************************************
//
// $Id: ParisShellDetectorConstruction.hh,v 1.8 2006/06/29 17:47:30 gunter Exp $
// GEANT4 tag $Name: geant4-08-02 $
//
#ifndef ParisShellDetectorConstruction_h
#define ParisShellDetectorConstruction_h 1
...
*/
class ParisShellDetectorConstruction : public G4VUserDetectorConstruction
{
public:
     //! constructor
     /*!
     	It reads the file named setup/shells.geo. If not found, default are:
\code	
#	Inner	NaI 	10.	15.	0.	360.	0.	180.	1
#	Outer	BGO 	25.	40.	0.	360.	0.	180.	1	
\endcode
     */
     ParisShellDetectorConstruction();
     ParisShellDetectorConstruction(G4String filename);     
     virtual ~ParisShellDetectorConstruction();
