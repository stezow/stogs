...
MACRO (ROOT_GENERATE_DICTIONARY__ INFILES LINKDEF_FILE OUTFILE INCLUDE_DIRS_IN)
  ...
  MESSAGE("DYLD_LIBRARY_PATH=${ROOT_LIBRARY_DIR} ROOTSYS=${ROOTSYS} ${ROOT_CINT_EXECUTABLE}
			 -f ${OUTFILE} -c -DHAVE_CONFIG_H ${INCLUDE_DIRS} ${INFILES} ${LINKDEF_FILE} 
			 WITHD : ${INFILES} ${LINKDEF_FILE}")
...
ENDMACRO (ROOT_GENERATE_DICTIONARY__)
...
function (GWROOT_GENERATE_DICTIONARY INFILES LINKDEF_FILE OUTFILE INCLUDE_DIRS_IN)
...
#  MESSAGE("INCLUDE_DIRS_IN: ${INCLUDE_DIRS_IN}")
#  MESSAGE("INFILES: ${INFILES}")
#  MESSAGE("OUTFILE: ${OUTFILE}")
#  MESSAGE("LINKDEF_FILE: ${LINKDEF_FILE}")
#  MESSAGE("INCLUDE_DIRS: ${INCLUDE_DIRS}")
...
# change extention source file in .h
  STRING(REGEX REPLACE "^(.*)\\.(.*)$" "\\1.h" bla "${OUTFILE}")
#  MESSAGE("BLA: ${bla}")
#  MESSAGE("OUT: ${OUTFILE}")
#  MESSAGE("OUT: ${ROOT_LIBRARY_DIR}")
...
ENDFUNCTION (GWROOT_GENERATE_DICTIONARY)
